export const games = {
  ...
  dbdSurviverTitle: 'DBD Random Survivor',
  dbdNoMember: '**Sorry, I could not find you!**',
  dbdKillerSent: '**Killer build sent!**',
  dbdSurviverSent: '**Survivor build sent!**',
  dbdKiller: 'Killer',
  dbdAddon: 'Addon',
  dbdOffering: 'Offering',
  dbdPerk: 'Perks',
  dbdLoot: 'Loot',
  dbdLookAddon: 'Loot Addons',
  dbdNoChallenge: `**Sorry, didn't find any challenges!**`,
  dbdKillerChallengeSent: '**Killer challenge sent!**',
  dbdSurvivorChallengeSent: '**Survivor challenge sent!**',
