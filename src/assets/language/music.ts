export const music = {
  dcNotInChannel: '**I cannot leave a voice channel that I am not in!**',
  dcLeft: '**I have left the voice channel.**',
  joinMoved: '**I have successfully moved to another voice channel.**',
